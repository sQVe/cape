...
and address or dismiss each one. Then rewrite the box to name the reviewer that ran
(`- [x] Code review by cape:code-reviewer, findings addressed or dismissed`) and tick it. On any
