...
a sub-issue of the AI plan issue through MCP: load `cape:tracker`, apply its agent contract, and run
the issue text through `cape:unslop` before posting. Then refresh the epic cache per
